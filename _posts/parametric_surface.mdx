...
excerpt: 'When it comes to visualizing an equation, the ability to decompose the equation into parametric equations is key. It is especially useful when creating creative 3D geometric surfaces mathematically and also a fun practice to see equations in a different perspective.'
date: '2024-10-18'
author:
  name: Kim Dong Hun
