  ...
  return (
    <section className="flex-col flex md:justify-between mt-16 mb-6 md:mb-10">
      ...
      <h4 className="md:text-left text-md mt-5 pr-6">
        I am a developer interested in building technologies that encourage people to create
        creative contents
      </h4>
      <div className="mt-[15px] flex space-x-1.5">
        <SocialIcon kind="github" href={`https://github.com/hunkim98`} size={6} />
        <SocialIcon kind="twitter" href={`https://twitter.com/hunkim98`} size={6} />
